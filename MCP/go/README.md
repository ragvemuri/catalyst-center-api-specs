# Assurance Sites Energy API MCP Server

This MCP (Model Content Protocol) server provides access to Assurance Sites Energy API API functionality through HTTP, HTTPS, and STDIO transport modes.
