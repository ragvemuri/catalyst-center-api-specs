# Open API Spec for Assurance Fabric Virtual Networks MCP Server

This MCP (Model Content Protocol) server provides access to Open API Spec for Assurance Fabric Virtual Networks API functionality through HTTP, HTTPS, and STDIO transport modes.
